...
Route::middleware(['auth', 'role:revisor|capturista', 'permission:anular publicacion bitacora|borrar bitacora|editar bitacora|publicar bitacora|revisar bitacora|ver bitacora|ver comision|revisar comision'])->group(function () {
    ...
    Route::get('/solicitud/pre/comision/create', [ComisionController::class, 'comisioncreatepre'])->name('solicitud.pre.comision.create');
    Route::post('/solicitud/pre/comision/store', [PreComisionController::class, 'store'])->name('solicitud.pre.comision.store');
    Route::get('/solicitud/pre/comision/detalle/{id}', [PreComisionController::class, 'show'])->name('solicitud.pre.comision.details');
