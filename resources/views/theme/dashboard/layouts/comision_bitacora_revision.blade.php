            ...
            <div class="col-lg-12 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-route"></i> Revisión de la Comisión del Vehículo {{ $sqlComisionGetRevision->placas }}</h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('solicitud.comision.validar.bitacora', base64_encode($sqlComisionGetRevision->solicitudId)) }}">
                            ...
                            <div class="form-row">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" name="memo_comision" id="memo_comision" class="@error('memo_comision') is-invalid @enderror form-control" autocomplete="off" value="{{ $sqlComisionGetRevision->memorandum_comision }}">
                                        @error('memo_comision')
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="date" name="fecha_comision" id="fecha_comision" class="@error('fecha_comision') is-invalid @enderror form-control" value="{{ $sqlComisionGetRevision->fecha }}">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="periodo_comision" name="periodo_comision" placeholder="click aquí" readonly value="{{ $sqlComisionGetRevision->periodo }}">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="placas_comision">Placas de Vehiculo</label>
                                    <div class="custom-file">
                                        <input type="text" class="@error('placas_comision') is-invalid @enderror typeahead form-control" id="placas_comision" name="placas_comision" placeholder="Placas de Vehiculo" autocomplete="off" value="{{ $sqlComisionGetRevision->placas }}">
                            ...
                            <div class="form-row">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="nombreConductor" name="nombreConductor" autocomplete="off" value="{{ $sqlComisionGetRevision->conductor }}">
                                    </div> 
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="kmInicial" name="kmInicial" autocomplete="off" value="{{ $sqlComisionGetRevision->km_inicial }}">
                                    </div> 
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="kmFinal">Kilometro Final</label>
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="kmFinal" name="kmFinal" autocomplete="off" value="{{ $sqlComisionGetRevision->km_final_antes_cargar_combustible }}">
                                    </div> 
                                </div> 
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <textarea name="observaciones" id="observaciones" cols="30" rows="5" class="form-control">{{ $sqlComisionGetRevision->observacion }}</textarea>
                                    </div> 
                                </div>
                            </div>
                            {{-- comentarios END --}}
