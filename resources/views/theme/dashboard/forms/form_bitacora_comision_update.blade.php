            ...
            <div class="col-lg-12 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-route"></i> Bitacora de Comisión para el vehiculo {{ $temporal->marca }}</h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('solicitud.pre.comision.enviar.registro') }}">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" name="memo_comision" id="memo_comision" class="@error('memo_comision') is-invalid @enderror form-control" autocomplete="off" value="{{ $temporal->memorandum_comision }}">
                                        @error('memo_comision')
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="date" name="fecha_comision" id="fecha_comision" class="@error('fecha_comision') is-invalid @enderror form-control" value="{{ $temporal->fecha }}">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="periodo_comision" name="periodo_comision" placeholder="click aquí" readonly value="{{ $temporal->periodo }}">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="placas_comision">Placas de Vehiculo</label>
                                    <div class="custom-file">
                                        <input type="text" class="@error('placas_comision') is-invalid @enderror typeahead form-control" id="placas_comision" name="placas_comision" placeholder="Placas de Vehiculo" autocomplete="off" value="{{ $temporal->placas }}">
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="form-control " id="marca_vehiculo" name="marca_vehiculo" placeholder="Marca del Vehiculo"  readonly value="{{ $temporal->marca }}">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="modelo">Modelo</label>
                                    <div class="custom-file">
                                        <input type="text" class="form-control " id="modelo" name="modelo" placeholder="Modelo"  readonly value="{{ $temporal->modelo }}">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="tipo">Tipo de Vehiculo</label>
                                    <div class="custom-file">
                                        <input type="text" class="form-control " id="tipo" name="tipo" placeholder="Tipo de Vehiculo"  readonly value="{{ $temporal->tipo }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="form-control " id="color" name="color" placeholder="Color"  readonly value="{{ $temporal->color }}">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="no_serie">N° de Serie</label>
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="no_serie" name="no_serie" placeholder="N° de Serie" readonly value="{{ $temporal->numero_serie }}">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="no_motor">N° de Motor</label>
                                    <div class="custom-file">
                                        <input type="text" class="@error('no_motor') is-invalid @enderror form-control " id="no_motor" name="no_motor" placeholder="N° de Motor" readonly value="{{ $temporal->numero_motor }}">
                                        @error('no_motor')
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="responsableUnidad" name="responsableUnidad" readonly value="{{ $temporal->resguardante_unidad }}">
                                    </div> 
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="placas">Puesto del responsable de la unidad</label>
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="puestoResponsableUnidad" readonly name="puestoResponsableUnidad" readonly value="{{ $temporal->puesto_resguardante_unidad }}">
                                    </div> 
                                </div>
                            </div>
                            <hr>
                            <div class="form-row">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="nombreConductor" name="nombreConductor" autocomplete="off" value="{{ $temporal->conductor }}">
                                    </div> 
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="kmInicial" name="kmInicial" autocomplete="off" value="{{ $temporal->km_inicial }}">
                                    </div> 
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="kmFinal">Kilometro Final</label>
                                    <div class="custom-file">
                                        <input type="text" class="form-control" id="kmFinal" name="kmFinal" autocomplete="off" value="{{ $temporal->km_final_antes_cargar_combustible }}">
                                    </div> 
                                </div> 
                            </div>
                            <input type="hidden" class="form-control" name="idcatvehiculo" id="idcatvehiculo" readonly value="{{ $temporal->vehiculoId }}">
                            <hr>
                            ...
                            <div class="field_wrapper">
                                <table class="table table-bordered" id="recorridotable">
                                    ...
                                    <tbody>
                                      @foreach ($recorrido_comision_temp as $k => $i)
                                       <tr>
                                            <td>
                                                <input type="date" name="addcomision[{{ $i->id }}][fecha_comision]" class="form-control" value="{{ $i->fecha_comision }}"/>
                                            </td>
                                            <td>
                                                <textarea name="addcomision[{{ $i->id }}][de_comision]" class="form-control">{{ $i->de_comision }}</textarea>
                                            </td>
                                            <td>
                            ...
                            <div class="table_wrapper">
                                <table class="table table-bordered" id="comisiontable">
                                    ...
                                    <tbody>
                                       @if (count($bitacora_comision_temp) > 0)
                                          @foreach ($bitacora_comision_temp as $k => $v)
                                            <tr>
                                                <td>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td data-label="TOTAL DE KILOMETROS">
                                            <input type="text" name="km_totales" id="km_totales"   class="form-control" readonly value="{{ $temporal->total_km_recorridos }}"/>
                                        </td>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <textarea name="observaciones" id="observaciones" cols="30" rows="5" class="form-control">{{ $temporal->observacion }}</textarea>
                                    </div> 
                                </div>
                            </div>
                            {{-- comentarios END --}}
...
@section('contenidoJavaScript')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var importeTotal = 0;
            var conteo_actual = 0;
            var cont_recorrido = '{{ count($recorrido_comision_temp) }}'
