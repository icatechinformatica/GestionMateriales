...
class CreateBitacoraComisionTemporalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bitacora_comision_temporal', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('bitacora_comision_temporal');
    }
}
